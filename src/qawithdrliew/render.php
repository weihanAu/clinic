...
<div  <?php echo get_block_wrapper_attributes(); ?>>
    <div class="link-hero">
        ...
        <div class="wp-block-presto-player-reusable-edit"><!--presto-player:video_id=2--><figure class="wp-block-video presto-block-video  presto-provider-self-hosted" style="--plyr-color-main: var(--presto-player-highlight-color, ); --presto-player-logo-width: 150px; ">
            <presto-player id="presto-player-1" src=<?php echo $attributes["video_url"] ?> media-title="compressed-TT-QA-branding" css="" class="presto-video-id-2 presto-preset-id-1 skin-modern hydrated ready" skin="modern" icon-url="https://theclinic.com.au/wp-content/plugins/presto-player/img/sprite.svg" preload="" poster="https://theclinic.com.au/wp-content/uploads/2024/03/Thumbnail-compressed.png" playsinline="" provider="self-hosted" style="height: auto;">
                    ...
                    player.video_id = 2;
                                                        player.preset = {"id":1,"name":"Default","slug":"default","icon":"format-video","skin":"modern","play-large":true,"rewind":true,"play":true,"fast-forward":true,"progress":true,"current-time":true,"mute":true,"volume":true,"speed":false,"pip":false,"fullscreen":true,"captions":false,"reset_on_end":true,"auto_hide":true,"show_time_elapsed":false,"captions_enabled":false,"save_player_position":true,"sticky_scroll":false,"sticky_scroll_position":"bottom right","on_video_end":"select","play_video_viewport":false,"hide_youtube":false,"lazy_load_youtube":false,"hide_logo":false,"border_radius":0,"caption_style":"","caption_background":"","is_locked":true,"cta":[""],"watermark":[""],"search":[""],"email_collection":[""],"action_bar":[""],"created_by":1,"created_at":"2024-03-03 20:12:14","updated_at":"2024-03-03 20:12:14","deleted_at":""};
                                                                        player.chapters = [{"time":"0:01","title":"What is an Abdominoplasty?"},{"time":"0:24","title":"How do you do your Abdominoplasty?"},{"time":"1:09","title":"Who is the ideal candidate for a tummy tuck (Abdominoplasty)?"},{"time":"1:45","title":"What does the surgery involve?"},{"time":"2:14","title":"What is the recovery like post Abdominoplasty surgery?"},{"time":"2:37","title":"What restrictions do I have after surgery?"},{"time":"3:35","title":"Are the results from a tummy tuck long lasting?"},{"time":"4:15","title":"What can I expect with Abdominoplasty surgery with Dr Liew?"}];
                    ...
                    {"@context":"https:\/\/schema.org","@type":"VideoObject","name":"compressed-TT-QA-branding","thumbnailUrl":"https:\/\/theclinic.com.au\/wp-content\/uploads\/2024\/03\/Thumbnail-compressed.png","uploadDate":"2024-03-08T02:49:53+00:00","contentUrl":"https:\/\/theclinic.com.au\/wp-content\/uploads\/2024\/03\/compressed-TT-QA-branding.mp4"}		</script>
                </div>
         ‘)</div>
        </div>
</div>
